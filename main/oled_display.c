...
static const uint8_t s_font_6x8[96][6] = {
    ...
    [33] = {0x7C, 0x12, 0x11, 0x12, 0x7C, 0x00}, /* A */
    ...
    [10] = {0x1E, 0x11, 0x24, 0x24, 0x11, 0x0E}, /* * */
};
...
{
    if (x + 6 > SSD1306_W || page < 0 || page >= SSD1306_PAGES)
        return;
...
{
    if (!s_inited || line < 0 || line >= SSD1306_PAGES)
        return;
